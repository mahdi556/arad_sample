  ...
  return (
    ...
    >
      <div className="d-flex col-12 p-4  " id="adbox">
        <div className="d-flex col-5 pe-2 flex-column  ">
          <div
            className="  mb-4"
            style={{
              fontSize: 18,
        ...
        <div className="d-flex col-4 pe-2 flex-column me-auto ">
          <h5>
            تاریخ ثبت :{moment(data.created_at).locale("fa").format("YYYY/M/D")}
          </h5>
          <h6>
            وضعیت آگهی :
