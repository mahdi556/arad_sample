...
const Login = () => {
    ...
    return (
        <>
            <div
                className={`d-flex px-3 py-2 me-4 align-items-center dashboard-button ${openMegaMenu ? "open" : "close"}`}
                // style={{
                //   borderRadius: 10,
          ...
          <>
            ...
            ورود/ثبت نام
                ...
                <img className={`ms-2 img ${openMegaMenu&&"rotate-image"}`}
                     src='/assets/images/arrow_black.svg'
                     width={18}
                />

                <div className={`fake-button ${openMegaMenu ? "d-block" : "d-none"}`}></div>
