    ...
    <>
      ...
      <div className="col-12  d-flex">
        <div className="input-group input-group-sm me-2">
          ...
          />
          <span className="input-group-text col-4 spanInputGroup">روز</span>
        </div>
        <div className="input-group input-group-sm mx-3 ">
          ...
          />
          <span className="input-group-text spanInputGroup col-4">ماه</span>
        </div>
        <div className="input-group input-group-sm ms-2">
          <input
            ...
            maxLength="4"
          />
          <span className="input-group-text col-4  spanInputGroup" dir="ltr">
            سال
          </span>
        </div>
      </div>
